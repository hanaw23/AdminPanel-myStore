    ...
    <>
      <div className="text-sm bg-gray-300 text-gray-700 ">
        ...
        <div className="mt-8 flex flex-col">
          ...
          <Select options={Categories} onChange={handleChangeCategory} defaultInputValue={category} className="w-[320px] h-10 mt-2  text-gray-700 focus:outline-blue-500" placeholder="Select Category" isClearable />
        </div>
        <div className="mt-8 flex flex-col">
