    ...
    <>
      <div className="text-sm bg-white overflow-auto">
        ...
        <div className="mt-4 flex flex-col">
          ...
          <textarea
            id="description"
            className="text-gray-700 px-3 border border-gray-300 rounded w-[320px] h-[60px] mt-2 focus:outline-blue-500 pt-2"
        ...
        <div className="mt-4 flex flex-col">
          ...
          <input
            id="videoUrl"
            type="text"
            className="text-gray-700 px-3 border border-gray-300 rounded w-[320px] h-10 mt-2 focus:outline-blue-500"
        ...
        <div>
          <div className="flex gap-8 mt-12 justify-center py-2">
