...
export const axiosCreateSecondary = (name, imageUrl, logoA, logoB, logoC, description, router, setSuccess, setFailed, setEmpty) => {
...
export const axiosEditSecondary = (idContent, name, description, router, setSuccess, setFailed, setEmpty) => {
  return async (dispatch) => {
    try {
